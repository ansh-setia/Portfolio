  ...
  const education = [
    {
      ...
      logo: "/CULOGO.jpg",
      description:
        "Specializing in Software Engineering, Data Structures, Algorithms, and Modern Web Technologies",
      highlights: [
    ...
    },
    {
      ...
      logo: " /dps_logo.jpg",
      description:
        "Strong foundation in Mathematics, Physics, Chemistry with Computer Science specialization",
      highlights: [
    ...
    },
    {
      ...
      logo: " /dps_logo.jpg",
      description:
        "Scout and guide, Badminton, cricket, and basketball player with a keen interest in extracurricular activities",
      highlights: [
        "Mathematics Excellence",
        "Computer Science",
        "Sports & Activities",
  ...
  const experiences = [
    {
      ...
      description:
        "Spearheading innovation initiatives across campus, fostering entrepreneurial mindset among students, and bridging the gap between academic learning and real-world application through strategic programs and events.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Orchestrating comprehensive brand campaigns that resonate with student communities, developing content strategies that amplify brand presence across multiple digital touchpoints and campus events.",
      achievements: [
      ...
      logo: " /Launched.png",
      photos: [" /Launched1.jpg", " /Launched2.jpg"],
    ...
    },
    {
      ...
      description:
        "Leading strategic initiatives for one of the university's premier technology societies, curating educational experiences that bridge theoretical knowledge with practical application in emerging technologies.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Orchestrating flagship university events including collaborations with industry leaders like Shark Tank's Aman Gupta, building a thriving community of 8,000+ students through innovative event experiences.",
      achievements: [
  ...
  const coreStrengths = [
    {
      ...
      description:
        "Analytical approach to complex challenges with systems-level thinking",
      proficiency: 92,
      category: "Leadership",
    },
    {
      ...
      description:
        "User-centered design with expertise in Figma and design systems",
      proficiency: 95,
      category: "Design",
    },
    {
      ...
      description:
        "Modern web technologies including React, Node.js, and databases",
      proficiency: 87,
      category: "Technical",
    },
    {
      ...
      description:
        "Building and inspiring teams toward shared visions and goals",
      proficiency: 88,
      category: "Leadership",
    },
    {
      ...
      description:
        "Creative solution architecture and entrepreneurial thinking",
      proficiency: 94,
      category: "Innovation",
    },
    {
      ...
      description:
        "Efficient delivery of complex projects under tight deadlines",
      proficiency: 90,
      category: "Management",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-cyan-400">innovative design</span>,
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
            <p>
              I'm <span className="text-white font-semibold">Ansh Setia</span>,
              a passionate
              <span className="text-cyan-400">
                {" "}
                final-year Computer Science student
              </span>{" "}
              at Chandigarh University. My journey in technology began with
              curiosity and has evolved into a mission to create meaningful
              digital experiences.
            </p>
            ...
            <p>
              ...
              <span className="text-cyan-400"> UI/UX design</span>, I bring
              together technical expertise with creative vision. My proficiency
              spans modern technologies like
              <span className="text-white"> React, Node.js, Python</span>, and
              design tools like <span className="text-white">Figma</span>.
            </p>

            <p>
              Beyond coding and designing, I'm a{" "}
              <span className="text-cyan-400">community builder</span>
              at heart. Through my leadership roles and organizing{" "}
              <span className="text-white">100+ events</span>, I've learned that
              the most impactful technology comes from understanding people and
        ...
        >
          {stats.map(({ icon: Icon, label, value, sublabel, color }, i) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${color} p-3 mb-4 group-hover:scale-110 transition-transform`}
              >
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {experience.achievements.map((achievement, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 p-4 bg-gray-700/30 rounded-xl"
                  >
